...
var yargs = require("yargs")
    .usage("Rename downloaded TV episodes.\n $0 [options] [file]")
...
if (argv.save_api_key) {
  ...
  try {
    /*jslint stupid: true*/
    fs.writeFileSync(__dirname + "/../config/traktApiKey.js", "module.exports = '" + argv.save_api_key + "';\n");
    /*jslint stupid: false*/
  } catch (e) {
    console.log("There was an error writing your file:", JSON.stringify(e));
    process.exit(1);
  }
